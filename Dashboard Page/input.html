...
<html lang="en" data-bs-theme="dark"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script src="./Dashboard Template · Bootstrap v5.3_files/color-modes.js.download"></script>
...
<meta name="theme-color" content="#712cf9">
    ...
    <link href="./Dashboard Template · Bootstrap v5.3_files/bootstrap-icons.min.css" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="./Dashboard Template · Bootstrap v5.3_files/dashboard.css" rel="stylesheet">
  </head>
  <body>
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-10 text-white" href="">Opulence Money</a>
  ...
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h4 class="offcanvas-title" id="sidebarMenuLabel">Opulence Money</h4>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          ...
          <!--<h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-body-secondary text-uppercase">
            ...
            <a class="link-secondary" href="Ú" aria-label="Add a new report">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="input-container">
        ...
        <div>
          <p class="inp-label">Income *</p>
          <input id = "inp-income" class ="input-data" type="text">
          <label for="inp-income">£</label>
          <p></p>
        </div>

        <div class="grid-container">
          <div>
            <p class="inp-label">Category</p>
            <div>
              <select name="categories" id="categories" class="categories">
                <option class = "dropCat" value="volvo">Groceries</option>
                <option value="saab">Holiday</option>
                <option value="opel">Household</option>
                <option value="audi">Transport</option>
              </select>
          </div>
        ...
        <div id="display-data" class="grid-container">
